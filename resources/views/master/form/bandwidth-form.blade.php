            ...
            <div class="col-md-12 col-md-12">
                <div class="grid simple">
                    <div class="grid-title no-border">
                        <h4>Form<span class="semi-bold"> Bandwidth </span></h4>
                        <div class="tools">
                    ...
                    <div class="grid-body no-border">
                        <br>
                        <div class="row">
                            <form class="form-horizontal" id="formGlasses" name="formGlasses" action="{{ url('bandwidth', @$data->id) }}" method="post">
                                {{ csrf_field() }}
                                @if (!empty($data))
                                  {{ method_field('PATCH') }}
                                @endif
                                ...
                                <div class="form-group" id="groupBenefit">
                                    ...
                                    <div class="col-sm-7 col-md-7">
                                        <input type="text" name="bandwidth" id="bandwidth" class="form-control" required placeholder="Bandwidth" value="{{ @$data->bandwidth }}" />
                                    </div>
                                </div>
