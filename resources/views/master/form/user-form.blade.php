            ...
            <div class="col-md-12 col-md-12">
                <div class="grid simple">
                    <div class="grid-title no-border">
                        <h4>Form<span class="semi-bold"> User </span></h4>
                        <div class="tools">
                    ...
                    <div class="grid-body no-border">
                        ...
                        <div class="row">
                            ...
                            <form class="form-horizontal" id="formGlasses" name="formGlasses" action="{{ url('user-add'.@$update, @$data->id) }}" method="post">
                                {{ csrf_field() }}
                                @if (!empty($data))
                                  {{ method_field('PATCH') }}
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-md-7">
                                        <div>
                                            <span id="status">
                                                <label for="user">
                                                    <input id="user" type="radio" name="role" value="user" {{ (@$data->role == 'user') ? "checked" : "" }} required>
                                                    User
                                                </label>
                                                <label for="admin">
                                                    <input id="admin" type="radio" name="role" value="admin" {{ (@$data->role == 'admin') ? "checked" : "" }}>
                                                    Admin
                                                </label>
                                            </span>
                                        </div>
