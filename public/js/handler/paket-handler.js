...
var FormValidation = function () {
    ...
    var faqValidation = function() {
            ...
            form.validate({
                ...
                messages:{
                    nama_paket:{
                        required: "Please Fill Nama Paket"
                    },
                    lokasi:{
                        required: "Please Fill Lokasi"
                    },
                    volume:{
                        required: "Please Fill Volume"
                    },
                    satuan:{
                        required: "Please Fill Satuan"
                    },
                    harga_satuan:{
                        required: "Please Fill Harga Satuan"
                    },
                },
...
$(document.body).on("change",".select2select",function(){
    ...
    select2Change($(this), $('#form_paket'));

});

// Reset Validation
function resetValidation(){
    $('#form_paket').each(function(){
    ...
    $('.alert-danger', $('#form_paket')).hide();
    $('.alert-success', $('#form_paket')).hide();
}